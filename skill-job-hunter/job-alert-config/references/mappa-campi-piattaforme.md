...
Mappature dal `search-profile` ai campi delle due piattaforme. I nomi di menu/filtri sono quelli tipici delle interfacce; possono variare per lingua dell'account e per aggiornamenti delle piattaforme — trattali come indicazioni del CONCETTO, non come nomi garantiti.

## LinkedIn (ricerca lavoro + "Crea avviso di offerte")

| Campo search-profile | Campo LinkedIn | Come compilarlo |
|---|---|---|
...
| Campo search-profile | Campo Indeed | Come compilarlo |
|---|---|---|
